...
namespace ParsecIntegrationClient.Services
{
    public class SettingsService
    {
        ...
        public static string QuerySelectIdDevCardString = "select cd.id_cardindev" +
            ...
            "and cd.attempts<20 order by cd.id_cardindev";
        ...
        {
            get { return ErrorTimeoutMinutes; }
            set { ErrorTimeoutMinutes = value; }
        }
        ...
        public static void Update()
        {
            ...
            else
            {
                ...
                LogLevel = string.IsNullOrWhiteSpace(settings._logLevel) ? "Warning" : settings._logLevel;
